...
def openFile():
    ...
    textFile = filedialog.askopenfilename(
        ...
        title="Abrir archivo",
        filetypes=(("Archivos de texto", "*.txt"), ("Archivos de ensamblador", "*.asm"))
    )
...
text_sentencias = Text(sentencias, wrap=NONE, state='disabled', width=97, height=10)
...
text_dataSegment = Text(dataSegment, wrap=NONE, state='disabled', width=97, height=10)
...
text_codeSegment = Text(codeSegment, wrap=NONE, state='disabled', width=97, height=10)
